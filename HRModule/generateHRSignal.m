...
%  - M0: Equilibrium signal for each tissue type (vector)
%  - T10_s: Longitudinal relaxation time in seconds for each tissue (vector)
%  - T2s0_s: Transversal relaxation time in seconds for each tissue (vector)
%  - FA_deg: Flip angle
...
function HR_SI = generateHRSignal(HR_Ct_mM, HR_tissue_map, HR_SI_nonbrain, M0, T10_s, T2s0_s, FA_deg, TR_s, TE_s, r1_perSpermM, r2_perSpermM, NTrue)
    %%Create 3D high resolution parameter images
