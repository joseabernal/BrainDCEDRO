...
function [LR_PS_perMin, LR_vP] = fitLRData(LR_SI, Cp_AIF_mM, LR_tissue_map, T10_s, TR_s,TE_s, FA_deg, r1_perSpermM, r2_perSpermM, t_res_s, NDes, region_wise_computations, regression_type, NIgnore)
    fit_options = struct('NIgnore', NIgnore, 'PatlakFastRegMode', regression_type);
