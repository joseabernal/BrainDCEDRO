...
function LR_SI = generateLRData(HR_k_space, motion_extent, SNR, NDiscard, NAcq, NFrames)
    ...
    for iFrame=1:NFrames
        LR_k_space_motion=add_motion_artifacts(LR_k_space(:,:,:,iFrame), motion_extent(iFrame));
